...
3. **Always Update:** After completing a task or stage, update the relevant memory documents to reflect the new state. This ensures that Gemini or any other agent picking up the project will have the exact same context.
